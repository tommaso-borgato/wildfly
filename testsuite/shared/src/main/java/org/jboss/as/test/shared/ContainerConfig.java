...
public class ContainerConfig {
    ...
    private static final String OPENTELEMETRY_COLLECTOR_IMAGE_CONFIG_KEY = "as-ts.opentelemetry-collector.image";
    private static final String OPENTELEMETRY_COLLECTOR_DEFAULT_IMAGE = "otel/opentelemetry-collector:0.115.1";

    private static final String ELASTICSEARCH_IMAGE_CONFIG_KEY = "as-ts.elasticsearch.image";
    private static final String ELASTICSEARCH_DEFAULT_IMAGE = "docker.elastic.co/elasticsearch/elasticsearch:8.15.4";

    private static final String MAILSERVER_IMAGE_CONFIG_KEY = "as-ts.mailserver.image";
    private static final String MAILSERVER_DEFAULT_IMAGE = "apache/james:demo-3.8.2";

    private static final String KAFKA_IMAGE_CONFIG_KEY = "as-ts.kafka-native.image";
    private static final String KAFKA_DEFAULT_IMAGE = "apache/kafka-native:3.8.0";

    private static final String ARTEMIS_IMAGE_CONFIG_KEY = "as-ts.activemq-artemis-broker.image";
    private static final String ARTEMIS_DEFAULT_IMAGE = "quay.io/arkmq-org/activemq-artemis-broker:artemis.2.42.0";

    private static final String KEYCLOAK_IMAGE_CONFIG_KEY = "as-ts.keycloak.image";
    private static final String KEYCLOAK_DEFAULT_IMAGE = "quay.io/keycloak/keycloak:24.0.1";
