...
class ConsoleHandler extends ServerLogHandler implements AccessLogHandler {
    private boolean autoFlush;

    private String encoding;

    public ConsoleHandler(final String name) {
        super(name);
    }

    public ConsoleHandler(final String name, final AccessLogFormatter formatter) {
